...
function Wishsection() {
    ...
    return <><div className='h-screen bg-[#023047] flex flex-col items-center justify-center'>
        ...
        <div className="w-[349px] h-[314px] rounded max-sm:w-[225px] max-sm:h-[250px] bg-cover" style={{ backgroundImage: `url("public/1000055631.jpg")` }}></div>
        <h1 className="font-mukta text-white text-8xl font-bold m-5 max-sm:text-4xl"><Typewriter
            options={{
                strings: ['<span style="color: #29E7CD;">Apsara😘 </span>', ' <span style="color: #F0F0C9;">Bauni</span>', '<span style="color: #D4F5F5;">Laadliii💋</span>'],
                delay: 200,
                autoStart: true,
                loop: true,
                cursor: ''
